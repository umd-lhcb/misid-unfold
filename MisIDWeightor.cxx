...
const TString pidfile_name = "../../pidcalib/myPid.root";
...
const TString PCutString = "BachMu_ProbNNp>0.1&&BachMu_PIDK<1&&!(BachMu_ProbNNk>0.1)&&!(BachMu_PIDmu>2)&&!(BachMu_ProbNNe>0.1)&&!(BachMu_ProbNNghost>0.2)";
const TString KCutString = "BachMu_ProbNNk>0.1&&!(BachMu_PIDmu>2)&&!(BachMu_ProbNNe>0.1)&&!(BachMu_ProbNNghost>0.2)";
...
void MisIDWeightor() {
  ...
  TString oldfilename = "/afs/cern.ch/user/z/ziyang/my_eos/RJpsi/tuples/2016_MisID_Data_MD_1-4k_MICRO.root";
  oldtree->Add(oldfilename.Data());

  TString newfilename = "/afs/cern.ch/user/z/ziyang/my_eos/RJpsi/tuples/2016_MisID_Data_MD_1-4k_unfold.root";
...
///    oldtree->SetBranchAddress("PIDWVar_DLL",&PIDWVar_DLL);
    ...
    MISIDTYPE = 1;
      ...
      // FILL
      newtree->Fill();
      if (i % 10000 == 0) {cout << "Filling tree,  "<< i << endl;}
    }
